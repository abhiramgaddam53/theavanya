...
export default function CommonRoomCard({
  ...
  return (
    <div className="relative w-full h-[56vh] min-h-[480px] overflow-hidden group cursor-pointer rounded-[24px]">
      <Image
        src={image}
        alt={name}
        fill
        ...
        <div className="mt-auto w-full flex flex-col gap-4">
          ...
          {description && (
            <div className="flex flex-col gap-4">
              <p className="font-poppins text-sm font-light text-gray-200 leading-relaxed max-w-xl drop-shadow-sm hidden">
                {description}
              </p>
