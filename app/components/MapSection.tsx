                    ...
                    <div className="w-full md:w-1/3 space-y-12">
                        ...
                        <div className="space-y-6 font-poppins text-neutral-300">
                            <p className="leading-relaxed">
                                ...
                                <br />
                                Shwetha Shubham, Sujeets Cricket Academy Rd, Jaibery Colony, Kompally,
                                <br />
                        ...
                        <div className="space-y-4 pt-6 text-neutral-300 border-t border-white/10">
                            <div className="flex justify-between items-center py-2 cursor-pointer group hover:text-white transition-colors">
