...
function CompleteBookingContent() {
  ...
  return (
    <main className="bg-primary-bg min-h-screen pt-32 pb-24 px-6 md:px-16">
      <div className="max-w-[1400px] mx-auto">
        <h1 className="font-poppins text-5xl md:text-6xl text-[#1a1a1a] mb-12">Complete Your Booking</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 relative">
          ...
          <div className="lg:col-span-8 flex flex-col gap-16">
            ...
            <section className="bg-white/50 border border-[#1a1a1a]/5 p-8 md:p-10 backdrop-blur-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-10">
                ...
                <Select
                  ...
                  options={[{ value: "usa", label: "United States" }, { value: "uk", label: "United Kingdom" }, { value: "in", label: "India" }]}
                />
              ...
              <div className="mt-8 flex items-center gap-3">
                <input type="checkbox" id="email-confirmation" className="accent-[#BEA585] w-4 h-4 cursor-pointer" />
                <label htmlFor="email-confirmation" className="font-poppins text-sm text-[#1a1a1a]/80 cursor-pointer">
            ...
            <section className="bg-white/50 border border-[#1a1a1a]/5 p-8 md:p-10 backdrop-blur-sm">
              <h2 className="font-poppins text-3xl text-[#1a1a1a] mb-8">Payment Information</h2>
              ...
              <div className="flex gap-6 mb-10 border-b border-[#1a1a1a]/10 pb-6">
                <label className="flex items-center gap-3 cursor-pointer">
                  ...
                  />
                  <span className="font-poppins text-sm font-medium uppercase tracking-wide">Pay Using Credit/Debit Card</span>
                </label>
                <label className="flex items-center gap-3 cursor-pointer opacity-50 hover:opacity-100 transition-opacity">
                  <input
                    ...
                    className="accent-[#1a1a1a] w-4 h-4"
                  />
                  <span className="font-poppins text-sm font-medium uppercase tracking-wide">Click To Pay</span>
                </label>
              </div>
            ...
            <section className="bg-white/50 border border-[#1a1a1a]/5 p-8 md:p-10 backdrop-blur-sm">
              <div className="mb-8">
                ...
                <p className="font-poppins text-sm text-[#1a1a1a]/70">Sign in or create a password to join Avanya Journey.</p>
              </div>

              <div className="flex items-center gap-3 mb-6">
                <input type="checkbox" checked readOnly className="accent-[#BEA585] w-4 h-4" />
                <label className="font-poppins text-sm font-bold text-[#1a1a1a]">Join Avanya Journey for Free</label>
              </div>
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <label className="font-poppins text-xs text-[#1a1a1a]/80">Remember me (Recommended for private computers only)</label>
              </div>
            </section>
            ...
            <section>
              ...
              <p className="font-poppins text-xs leading-relaxed text-[#1a1a1a]/70 mb-6">
                You may cancel your reservation for no charge before 11:59 PM hotel time on December 1, 2025 (14 days before arrival). After this time, please note that your prepayment for this special rate is non-refundable.
              </p>
