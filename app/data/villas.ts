...
export const villas: Villa[] = [
    {
        ...
        availableRooms: [
            { id: "c1", title: "Canopy Suite 101", description: "Best view of the valley with direct sunrise view.", price: "₹45,000", imageSrc: "/suits/queen.jpg", features: ["1 King Bed", "Valley View"], type: "Suite" },
            { id: "c2", title: "Canopy Suite 102", description: "Located near the waterfall, offers soothing sounds.", price: "₹48,000", imageSrc: "/suits/queen.jpg", features: ["1 King Bed", "Waterfall Sound"], type: "Suite" },
            { id: "c3", title: "Canopy Premier", description: "Highest elevated suite with panoramic horizon views.", price: "₹52,000", imageSrc: "/suits/queen.jpg", features: ["1 King Bed", "Panoramic View"], type: "Guest Room" },
            { id: "c4", title: "Canopy Twin", description: "Ideal for friends, featuring two twin beds and forest view.", price: "₹45,000", imageSrc: "/suits/queen.jpg", features: ["2 Twin Beds", "Forest View"], type: "Guest Room" },
            { id: "c5", title: "Royal Canopy Suite", description: "Extra spacious suite with private dining area.", price: "₹60,000", imageSrc: "/suits/queen.jpg", features: ["1 King Bed", "Private Dining"], type: "Suite" },
        ],
    ...
    },
    {
        ...
        availableRooms: [
            { id: "e1", title: "Estate Room A", description: "Heritage wing with original woodwork.", price: "₹65,000", imageSrc: "/suits/premium.jpg", features: ["2 Queen Beds", "Heritage Decor"], type: "Guest Room" },
            { id: "e2", title: "Estate Room B", description: "Featuring a large veranda overlooking the courtyard.", price: "₹68,000", imageSrc: "/suits/premium.jpg", features: ["2 Queen Beds", "Courtyard View"], type: "Guest Room" },
            { id: "e3", title: "Estate Family Suite", description: "Interconnected rooms perfect for larger families.", price: "₹75,000", imageSrc: "/suits/premium.jpg", features: ["3 Queen Beds", "Interconnected"], type: "Suite" },
            { id: "e4", title: "Estate Garden Suite", description: "Direct access to the private herb garden.", price: "₹70,000", imageSrc: "/suits/premium.jpg", features: ["2 Queen Beds", "Garden Access"], type: "Suite" },
            { id: "e5", title: "Grand Estate Hall", description: "The largest suite in the retreat, fit for royalty.", price: "₹85,000", imageSrc: "/suits/premium.jpg", features: ["2 King Beds", "Royal Suite"], type: "Suite" },
        ],
    ...
    },
    {
        ...
        availableRooms: [
            { id: "r1", title: "Pool Villa 01", description: "Private infinity pool facing the sunset.", price: "₹85,000", imageSrc: "/suits/duplex.jpg", features: ["1 King Bed", "Private Pool"], type: "Villa" },
            { id: "r2", title: "Pool Villa 02", description: "Secluded garden view with an outdoor shower.", price: "₹85,000", imageSrc: "/suits/duplex.jpg", features: ["1 King Bed", "Garden View"], type: "Villa" },
            { id: "r3", title: "Pool Villa 03", description: "Closest to the spa and wellness center.", price: "₹88,000", imageSrc: "/suits/duplex.jpg", features: ["1 King Bed", "Near Spa"], type: "Villa" },
            ...
            { id: "r5", title: "Pool Suite Premium", description: "Extra large pool deck for private sunbathing.", price: "₹92,000", imageSrc: "/suits/duplex.jpg", features: ["1 King Bed", "Large Deck"], type: "Suite" },
        ],
